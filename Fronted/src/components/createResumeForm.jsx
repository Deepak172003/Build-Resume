...
import { Input } from "./Inputs"; // or change your Inputs.jsx export to `export const Input`
  ...
  return (
    <div className="w-full max-w-md p-8 bg-white rounded-2xl border border-gray-100 shadow-lg">
      ...
      <form onSubmit={handleCreateResume}>
        ...
        <button
          type="submit"
          className="w-full py-3 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-semibold rounded-xl hover:scale-105 hover:shadow-xl transition-all"
        >
          Create Resume
        </button>
      </form>
