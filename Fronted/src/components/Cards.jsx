...
import { UserContext } from "../context/UserContext"; // make sure this exists
  ...
  return (
    ...
    >
      {thumbnailImg ? (
        ...
        <div className="w-full h-[200px] flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 to-violet-100 mb-3">
          <Edit className="text-violet-600" size={20} />
          <span className="text-gray-700 font-bold mt-2">No preview</span>
        </div>
      )}
    </div>
  );
